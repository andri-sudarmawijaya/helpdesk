    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="about"><a href="{{url('/about')}}">Tentang Aplikasi</a></li>
                <li class="contact"><a href="{{url('/contact')}}">Kontak</a></li>
                @if(Auth::user())
                    @if(Auth::user()->hasRole('admin'))
                        <li class="ticket"><a href="{{url('tickets')}}">Dashboard</a></li>
                        @else
                        <li class="ticket"><a href="{{url('tickets')}}">Tiket Bantuan</a></li>
                    @endif
